...
!(function (e, t) {
  ...
  var T = "ControlSidebar",
    ...
    M = (function () {
      ...
      return (
        ...
        (t.toggle = function () {
          var e = n.default("body");
          e.hasClass(L) || e.hasClass(D) ? this.collapse() : this.show();
        }),
        (t._init = function () {
          var e = this,
            t = n.default("body");
        ...
        (t.removeActiveTab = function (e, t) {
          if ("all" == e)
            ...
            n.default(ve + ":not(.active)").remove(),
              n.default(Ce + ":not(.active)").remove();
          else if ("only-this" == e) {
            var a = n.default(t),
              i = a.parent(".nav-item"),
              o = i.parent(),
        ...
        (t.fixLayoutHeight = function (e) {
          ...
          var i = {
              ...
              header:
                ...
                !n.default("body").hasClass("layout-navbar-fixed")
    ...
    ht = (function () {
      ...
      return (
        ...
        (a._renderItem = function (e, t, a) {
          ...
          var s = n.default("<a/>", { href: t, class: "list-group-item" }),
  ...
  n.default(document).on("click", vt, function (e) {
    ...
    "navbar-search" !== t.data("widget") && (t = t.closest(vt)),
      wt._jQueryInterface.call(t, "toggle");
  }),
    (n.default.fn[gt] = wt._jQueryInterface),
    (n.default.fn[gt].Constructor = wt),
    (n.default.fn[gt].noConflict = function () {
      return (n.default.fn[gt] = mt), wt._jQueryInterface;
    });
  var Ct = n.default.fn.Toasts,
    xt = "topRight",
    It = "topLeft",
    Tt = "bottomRight",
    St = "bottomLeft",
  ...
  (n.default.fn.Toasts = kt._jQueryInterface),
    ...
    (n.default.fn.Toasts.noConflict = function () {
      return (n.default.fn.Toasts = Ct), kt._jQueryInterface;
    });
  var Qt = "TodoList",
    Ht = "lte.todolist",
    zt = n.default.fn[Qt],
